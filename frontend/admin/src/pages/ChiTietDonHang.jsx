...
const ChiTietDonHang = (packageId, urlupdate, urltruyen) => {
  var department_id = localStorage.getItem("department_id");
  var username = localStorage.getItem("username");
  console.log("di", department_id);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(urlupdate, body, {
        headers: {
          "Content-Type": "application/json",
        },
      });
                  ...
                  <div className="w-90">
                    ...
                    >
                      ...
                      <option
                        ...
                        hidden={formData.stage === "giao thành công"}
                      >
                        giao thành công
                      </option>
                      <option
                        value="giao thất bại"
                        hidden={formData.stage === "giao thất bại"}
                      >
                        giao thất bại
                      </option>
                    </select>
